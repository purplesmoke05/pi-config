...
export const WORKFLOW_AUTHORING_FROZEN_FILES = [
  ...
  },
  {
    ...
    sha256: "4fe244b4723d8c108dfff2da0429870464dcf36888132ebe1213d57deebcf86a",
  },
  {
  ...
  },
  {
    ...
    sha256: "028a519e74253ab2fd97d83114e3bace77682fbe64ce9338b95950ecb0fe7eb2",
  },
  {
  ...
  },
  {
    ...
    sha256: "48a8141d1aec275e2e6c7a5dd302765896bc58891f4edcc4ec545dce2fb393a3",
  },
  {
  ...
  },
  {
    ...
    sha256: "ec4604dde67759d10d4800a222b6227d5fe3cf860de86d3b3ef78ce0fc74b24b",
  },
  {
    path: "skills/workflow-authoring/references/debugging.md",
    sha256: "7a8c9e8f29abe62ccc78a7f0a4c6404e4bd71b06103c08e6967d7b9dd8f0c6da",
  },
  {
  ...
  "workflow.runtime.args": [
    {
      path: RUNTIME_PATH,
      requiredText:
        "The supported runtime supplies `agent`, `parallel`, `pipeline`, quality/control helpers, `phase`, `log`, `args`, `cwd`, restricted `process.cwd()`, and `budget`.",
    },
  ],
...
export const WORKFLOW_AUTHORING_RECIPE_IDS = [
  ...
  "workflow.recipe.single-script-child-jobs",
...
const RECIPE_COVERAGE: readonly WorkflowAuthoringCoverageEntry[] = [
  ...
  {
    id: "workflow.recipe.single-script-child-jobs",
    kind: "recipe",
    reference: { path: RECIPE_PATH },
    example: "skills/workflow-authoring/examples/single-script-child-jobs.js",
    behaviorEvidence: ["tests/workflow-authoring-skill.test.ts", "tests/workflow-comprehension.test.ts"],
    comprehensionScenarios: ["full-edit"],
    protection: WorkflowAuthoringProtection.BEHAVIORALLY_COVERED,
    protectedGuidance: [],
