...
export interface NotifyCtx {
  ...
  confirmed: Array<{ title: string; message: string }>;
}

/** A command context that captures notifications and confirmation dialogs. */
export function makeNotifyCtx(options: { hasUI?: boolean; confirmResult?: boolean } = {}): NotifyCtx {
