...
| Child workflow logic | Keep bounded child jobs sequential and directly visible in the approved parent; the audited host rejects in-script `workflow(...)` nesting. | [Single-script child jobs](../examples/single-script-child-jobs.js) |
