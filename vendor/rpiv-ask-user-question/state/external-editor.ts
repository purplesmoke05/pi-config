...
/** Pi 0.80.2's canonical editor lookup: VISUAL takes precedence over EDITOR. */
export function resolveExternalEditorCommand(environment: NodeJS.ProcessEnv = process.env): string | undefined {
	return environment.VISUAL?.trim() || environment.EDITOR?.trim() || undefined;
}
