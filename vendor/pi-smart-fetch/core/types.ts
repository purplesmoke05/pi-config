...
export interface FetchOptions {
  url: string;
  /** Deprecated compatibility fields; Node transport does not fingerprint browsers. */
  browser?: string;
  ...
  timeoutMs?: number;
  signal?: AbortSignal;
  /** Ignored. Downloads are always written under the agent cache. */
  tempDir?: string;
}
...
export interface FetchResponseLike {
  ...
  statusText: string;
  url: string;
  /** True when an earlier HTTP redirect permanently removed credential headers. */
